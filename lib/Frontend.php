...
class Frontend extends ApiFrontend {
    function init(){
        ...
        $this->add('H1',null,'logo')->set('CORPORATE SECURITY SERVICES')->setStyle('color','orange');

        $this->add('Menu',null,'Menu')
            ->addMenuItem('index','New Bill')
            ->addMenuItem('billreport','Bill Report')
            ->addMenuItem('party','Party Management')
            ->addMenuItem('services','Services Management')
            //->addMenuItem('registration','New Registration')
            //->addMenuItem('registrationreport','Registration Report')
            //->addMenuItem('terms','Create Your Terms and Condition')
